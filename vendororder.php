                                                        ...
                                                        <table id="myTable03a" style="width:100%;" class="display table table-bordered wrap">
                                                            ...
                                                            <tbody id="myTable">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="display:none;"><input type="text" readonly class="form-control" id="trans_sellingtype" name="trans_sellingtype[]" value="Wholesale"></td> 
                                                                    <td style="display:none;"><input type="text" readonly class="form-control" id="trans_class" name="trans_class[]" value="Class A"></td> 
                                                                    <td style="display:none;"><input type="text" readonly class="form-control" id="trans_price" name="trans_price[]" value="<?php echo $result1 ['comm_wsp']; ?>"></td> 
